...
import { TransactionFromJSON, TransactionFromJSONTyped, TransactionToJSON, TransactionToJSONTyped } from './Transaction'
...
export function GroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): Group {
  ...
  return {
    ...
    transactions:
      json['transactions'] == null ? undefined : (json['transactions'] as Array<any>).map(TransactionFromJSON),
...
export function GroupToJSONTyped(value?: Group | null, ignoreDiscriminator: boolean = false): any {
  ...
  return {
    ...
    transactions:
      value['transactions'] == null ? undefined : (value['transactions'] as Array<any>).map(TransactionToJSON),
