...
export function TransactionDraftDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionDraftDto {
  ...
  return {
    ...
    balances:
      json["balances"] == null ? undefined : (json["balances"] as Array<any>).map(TransactionDraftBalanceDtoFromJSON)
  };
}
...
export function TransactionDraftDtoToJSONTyped(
  value?: TransactionDraftDto | null,
  ...
  return {
    ...
    photo: value["photo"],
    balances:
      value["balances"] == null ? undefined : (value["balances"] as Array<any>).map(TransactionDraftBalanceDtoToJSON)
  };
}
