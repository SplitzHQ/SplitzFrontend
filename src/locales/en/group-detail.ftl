...
group-detail-invoices-title = Invoices
group-detail-invoice-unnamed = Untitled Invoice
group-detail-invoice-created-by = Created by { $name }
group-detail-invoice-settled = Settled
group-detail-invoice-open = Open
