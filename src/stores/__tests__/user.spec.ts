...
describe("useUserStore email account actions", () => {
  ...
  it("treats failed transactional email capability lookup as unavailable", async () => {
    accountEmailApiMock.getEmailCapabilities.mockRejectedValue(new Error("network down"));
